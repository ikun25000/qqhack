...
public class ChooseUtils {
     ...
     */
    @TargetApi(28)
    public static <T> ArrayList<T> choose(Class<T> clazz) throws Exception {
     ...
     */
    @TargetApi(28)
    public static synchronized ArrayList<Object> choose(Class clazz, boolean assignable) throws Exception {
